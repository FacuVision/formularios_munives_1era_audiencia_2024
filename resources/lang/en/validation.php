...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "lastname_m"=> "Apellido Materno del participante",
        "lastname_p"=> "Apellido Paterno del participante",
        "document"=> "N° Documento del participante",
        "organization"=> "Tipo de organizacion del participante",
        "territory"=> "Dirección del participante"
    ],
